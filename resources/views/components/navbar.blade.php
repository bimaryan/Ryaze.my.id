<nav class="fixed top-0 z-50 w-full shadow bg-white dark:text-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800" x-data="{ userMenuOpen: false, notifOpen: false }">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start gap-2 rtl:justify-end">
                ...
                <a href="{{ url('/') }}" class="flex items-center gap-2.5 ms-2 md:ms-0">
                    ...
                    @endif
                    <span class="text-xl font-bold tracking-tight text-indigo-600 dark:text-indigo-400 whitespace-nowrap">{{ $siteName }}</span>
                </a>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="relative">
                    <button @click="notifOpen = !notifOpen; userMenuOpen = false" @click.outside="notifOpen = false"
                        ...
                        @if ($unreadNotifications->count() > 0)
                            <div class="absolute flex items-center justify-center w-5 h-5 bg-red-500 border-2 border-white rounded-full -top-0.5 start-4 dark:border-gray-900">
                    ...
                    <div x-show="notifOpen" style="display: none;"
                        ...
                        <div class="block px-4 py-2 font-medium text-center text-gray-700 rounded-t-lg bg-gray-50 dark:bg-gray-800 dark:text-white flex justify-between items-center">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-gray-700 max-h-72 overflow-y-auto">
                            ...
                            @empty
                                <p class="px-4 py-3 text-sm text-center text-gray-500 dark:text-gray-400">Belum ada notifikasi baru.</p>
                            @endforelse
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 ms-2 relative">
                    ...
                    <div>
                        <button @click="userMenuOpen = !userMenuOpen; notifOpen = false" @click.outside="userMenuOpen = false" type="button"
                    ...
                    <div x-show="userMenuOpen" style="display: none;"
                        ...
                        <ul class="py-1" role="none">
                            <li>
                                <a href="{{ route('profile.edit') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">Profil Saya</a>
                            </li>
                            <li>
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="w-full text-left block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white text-red-600 dark:text-red-400">
...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-900 flex flex-col">
        @php
            ...
            $sectionLabel = 'mt-5 mb-2 px-2 text-xs font-semibold text-gray-500 uppercase tracking-wider dark:text-gray-400';
        @endphp
        ...
        <ul class="space-y-1.5 font-medium">
            ...
            <li>
                <a href="{{ $dashboardUrl }}" class="{{ $navLink(request()->routeIs('*.dashboard')) }}">
                    <i class="fa-solid fa-table-columns {{ $iconBox(request()->routeIs('*.dashboard')) }} text-center"></i>
            ...
            @if ($role === 'superadmin')
                <li class="{{ $sectionLabel }}">Sistem Utama</li>
                
                <li>
                    <a href="{{ route('superadmin.users.index') }}" class="{{ $navLink(request()->routeIs('superadmin.users*')) }}">
                        <i class="fa-solid fa-users {{ $iconBox(request()->routeIs('superadmin.users*')) }} text-center"></i>
                ...
                <li>
                    <a href="{{ route('superadmin.portfolios.index') }}" class="{{ $navLink(request()->routeIs('superadmin.portfolios*')) }}">
                        <i class="fa-solid fa-briefcase {{ $iconBox(request()->routeIs('superadmin.portfolios*')) }} text-center"></i>
                        <span class="ms-3">Portofolio</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.promo_events.index') }}" class="{{ $navLink(request()->routeIs('admin.promo_events*')) }}">
                        <i class="fa-solid fa-bullhorn {{ $iconBox(request()->routeIs('admin.promo_events*')) }} text-center"></i>
                        <span class="ms-3">Promo Event</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('superadmin.articles.index') }}" class="{{ $navLink(request()->routeIs('superadmin.articles*') || request()->routeIs('superadmin.article_categories*')) }}">
                        <i class="fa-solid fa-newspaper {{ $iconBox(request()->routeIs('superadmin.articles*') || request()->routeIs('superadmin.article_categories*')) }} text-center"></i>
                        <span class="ms-3">Manajemen Blog</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('superadmin.settings') }}" class="{{ $navLink(request()->routeIs('superadmin.settings*')) }}">
                        <i class="fa-solid fa-sliders {{ $iconBox(request()->routeIs('superadmin.settings*')) }} text-center"></i>
                ...
                <li>
                    <a href="{{ route('superadmin.backup.index') }}" class="{{ $navLink(request()->routeIs('superadmin.backup*')) }}">
                        <i class="fa-solid fa-box-archive {{ $iconBox(request()->routeIs('superadmin.backup*')) }} text-center"></i>
                        <span class="ms-3">Sistem Backup</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('superadmin.withdrawals.index') }}" class="{{ $navLink(request()->routeIs('superadmin.withdrawals*')) }}">
                        <i class="fa-solid fa-money-bill-transfer {{ $iconBox(request()->routeIs('superadmin.withdrawals*')) }} text-center"></i>
                        <span class="ms-3">Kelola Penarikan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('superadmin.finance') }}" class="{{ $navLink(request()->routeIs('superadmin.finance')) }}">
                        <i class="fa-solid fa-chart-pie {{ $iconBox(request()->routeIs('superadmin.finance')) }} text-center"></i>
            ...
            {{-- ── MANAJEMEN JOKI ──────────────────────────────────────────────── --}}
            @if ($isAdminJoki)
                <li class="{{ $sectionLabel }}">Manajemen Joki</li>

                <li>
                    <a href="{{ route('admin_joki.orders') }}" class="{{ $navLink(request()->routeIs('admin_joki.orders*')) }}">
                        <i class="fa-solid fa-code-branch {{ $iconBox(request()->routeIs('admin_joki.orders*')) }} text-center"></i>
                        <span class="ms-3">Kelola Pesanan Joki</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_joki.services.index') }}" class="{{ $navLink(request()->routeIs('admin_joki.services*')) }}">
                        <i class="fa-solid fa-list-check {{ $iconBox(request()->routeIs('admin_joki.services*')) }} text-center"></i>
                        <span class="ms-3">Manajemen Layanan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_joki.finance') }}" class="{{ $navLink(request()->routeIs('admin_joki.finance')) }}">
                        <i class="fa-solid fa-wallet {{ $iconBox(request()->routeIs('admin_joki.finance')) }} text-center"></i>
                        <span class="ms-3">Keuangan Joki</span>
                    </a>
                </li>
            @endif
            ...
            {{-- ── MANAJEMEN HOSTING ───────────────────────────────────────────── --}}
            @if ($isAdminHosting)
                <li class="{{ $sectionLabel }}">Manajemen Hosting</li>

                <li>
                    <a href="{{ route('admin_hosting.projects') }}" class="{{ $navLink(request()->routeIs('admin_hosting.projects')) }}">
                        <i class="fa-solid fa-server {{ $iconBox(request()->routeIs('admin_hosting.projects')) }} text-center"></i>
                        <span class="ms-3">Kelola Project</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.deployments') }}" class="{{ $navLink(request()->routeIs('admin_hosting.deployments')) }}">
                        <i class="fa-solid fa-clock-rotate-left {{ $iconBox(request()->routeIs('admin_hosting.deployments')) }} text-center"></i>
                        <span class="ms-3">Riwayat Deploy</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.pending') }}" class="{{ $navLink(request()->routeIs('admin_hosting.pending')) }}">
                        <i class="fa-solid fa-triangle-exclamation {{ $iconBox(request()->routeIs('admin_hosting.pending')) }} text-center"></i>
                        <span class="ms-3">Butuh Tindakan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.databases') }}" class="{{ $navLink(request()->routeIs('admin_hosting.databases')) }}">
                        <i class="fa-solid fa-database {{ $iconBox(request()->routeIs('admin_hosting.databases')) }} text-center"></i>
                        <span class="ms-3">Semua Database</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.storage') }}" class="{{ $navLink(request()->routeIs('admin_hosting.storage')) }}">
                        <i class="fa-solid fa-hard-drive {{ $iconBox(request()->routeIs('admin_hosting.storage')) }} text-center"></i>
                        <span class="ms-3">Limit Penyimpanan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.billing') }}" class="{{ $navLink(request()->routeIs('admin_hosting.billing')) }}">
                        <i class="fa-solid fa-file-invoice-dollar {{ $iconBox(request()->routeIs('admin_hosting.billing')) }} text-center"></i>
                        <span class="ms-3">Kelola Tagihan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.vouchers.index') }}" class="{{ $navLink(request()->routeIs('admin_hosting.vouchers*')) }}">
                        <i class="fa-solid fa-ticket {{ $iconBox(request()->routeIs('admin_hosting.vouchers*')) }} text-center"></i>
                        <span class="ms-3">Kelola Voucher</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.tickets.index') }}" class="{{ $navLink(request()->routeIs('admin_hosting.tickets*')) }}">
                        <i class="fa-solid fa-headset {{ $iconBox(request()->routeIs('admin_hosting.tickets*')) }} text-center"></i>
                        <span class="ms-3">Kelola Tiket</span>
                    </a>
                </li>
            @endif
            ...
            {{-- ── LAYANAN KLIEN JOKI ──────────────────────────────────────────── --}}
            @if ($isUserJoki)
                <li class="{{ $sectionLabel }}">Layanan Joki</li>

                <li>
                    <a href="{{ route('user_joki.create') }}" class="{{ $navLink(request()->routeIs('user_joki.create')) }}">
                        <i class="fa-solid fa-cart-plus {{ $iconBox(request()->routeIs('user_joki.create')) }} text-center"></i>
                        <span class="ms-3">Buat Pesanan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_joki.progress') }}" class="{{ $navLink(request()->routeIs('user_joki.progress')) }}">
                        <i class="fa-solid fa-laptop-code {{ $iconBox(request()->routeIs('user_joki.progress')) }} text-center"></i>
                        <span class="ms-3">Progres Pengerjaan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_joki.riwayat') }}" class="{{ $navLink(request()->routeIs('user_joki.riwayat')) }}">
                        <i class="fa-solid fa-clock-rotate-left {{ $iconBox(request()->routeIs('user_joki.riwayat')) }} text-center"></i>
                        <span class="ms-3">Riwayat Selesai</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_joki.billing') }}" class="{{ $navLink(request()->routeIs('user_joki.billing')) }}">
                        <i class="fa-solid fa-file-invoice-dollar {{ $iconBox(request()->routeIs('user_joki.billing')) }} text-center"></i>
                        <span class="ms-3">Riwayat Tagihan</span>
                    </a>
                </li>
            @endif
            ...
            @if ($isUserHosting)
                <li class="{{ $sectionLabel }}">Hosting</li>

                <li>
                    <a href="{{ route('user_hosting.marketplace') }}" class="{{ $navLink(request()->routeIs('user_hosting.marketplace')) }}">
                        <i class="fa-solid fa-rocket {{ $iconBox(request()->routeIs('user_hosting.marketplace')) }} text-center"></i>
                        <span class="ms-3">Deploy Aplikasi</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.apk.index') }}" class="{{ $navLink(request()->routeIs('user_hosting.apk*')) }}">
                        <i class="fa-brands fa-android {{ $iconBox(request()->routeIs('user_hosting.apk*')) }} text-center"></i>
                        <span class="ms-3">Web to APK</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.tunnels.index') }}" class="{{ $navLink(request()->routeIs('user_hosting.tunnels*')) }}">
                        <i class="fa-solid fa-network-wired {{ $iconBox(request()->routeIs('user_hosting.tunnels*')) }} text-center"></i>
                        <span class="ms-3">Local Tunnels</span>
                        <span class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-purple-800 bg-purple-100 rounded-full dark:bg-purple-900 dark:text-purple-300">Beta</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.templates') }}" class="{{ $navLink(request()->routeIs('user_hosting.templates')) }}">
                        <i class="fa-solid fa-layer-group {{ $iconBox(request()->routeIs('user_hosting.templates')) }} text-center"></i>
                        <span class="ms-3">Galeri Template</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.projects') }}" class="{{ $navLink(request()->routeIs('user_hosting.projects') || request()->routeIs('user_hosting.show')) }}">
                        <i class="fa-solid fa-terminal {{ $iconBox(request()->routeIs('user_hosting.projects') || request()->routeIs('user_hosting.show')) }} text-center"></i>
                        <span class="ms-3">Proyek Aktif</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.databases') }}" class="{{ $navLink(request()->routeIs('user_hosting.databases') && !request()->routeIs('user_hosting.databases.pma')) }}">
                        <i class="fa-solid fa-database {{ $iconBox(request()->routeIs('user_hosting.databases') && !request()->routeIs('user_hosting.databases.pma')) }} text-center"></i>
                ...
                <li>
                    <a href="{{ route('user_hosting.databases.pma') }}" class="{{ $navLink(request()->routeIs('user_hosting.databases.pma')) }}">
                        <i class="fa-solid fa-table-columns {{ $iconBox(request()->routeIs('user_hosting.databases.pma')) }} text-center"></i>
                        <span class="ms-3">DB Manager</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.storage') }}" class="{{ $navLink(request()->routeIs('user_hosting.storage*')) }}">
                        <i class="fa-solid fa-folder-open {{ $iconBox(request()->routeIs('user_hosting.storage*')) }} text-center"></i>
                        <span class="ms-3">File & Storage</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.docs') }}" class="{{ $navLink(request()->routeIs('user_hosting.docs*')) }}">
                        <i class="fa-solid fa-book-open {{ $iconBox(request()->routeIs('user_hosting.docs*')) }} text-center"></i>
                        <span class="ms-3">Dokumentasi</span>
                    </a>
                </li>

                <li class="{{ $sectionLabel }} mt-4">Akun</li>

                <li>
                    <a href="{{ route('user_hosting.subscription') }}" class="{{ $navLink(request()->routeIs('user_hosting.subscription')) }}">
                        <i class="fa-solid fa-crown {{ $iconBox(request()->routeIs('user_hosting.subscription')) }} text-center"></i>
                        <span class="ms-3">Langganan Paket</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.tickets.index') }}" class="{{ $navLink(request()->routeIs('user_hosting.tickets*')) }}">
                        <i class="fa-solid fa-headset {{ $iconBox(request()->routeIs('user_hosting.tickets*')) }} text-center"></i>
