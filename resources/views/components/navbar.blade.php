...
{{-- SIDEBAR --}}
<aside id="logo-sidebar" x-data="{ collapsed: JSON.parse(localStorage.getItem('ryaze_sidebar_collapsed') || 'false') }" x-init="$watch('collapsed', value => localStorage.setItem('ryaze_sidebar_collapsed', JSON.stringify(value)))"
    :class="`${sidebarOpen && !desktop ? 'translate-x-0 shadow-2xl' : (desktop ? 'translate-x-0' : '-translate-x-full')} ${collapsed ? 'lg:w-20' : 'lg:w-64'}`"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-900 flex flex-col">
        ...
        <div class="hidden lg:flex mb-2" :class="collapsed ? 'justify-center' : 'justify-end'">
        ...
        <ul class="space-y-1.5 font-medium">
            ...
            <li>
                <a href="{{ $dashboardUrl }}" class="{{ $navLink(request()->routeIs('*.dashboard')) }}">
                    ...
                    <span class="ms-3" x-show="!collapsed" x-cloak>Dashboard</span>
                </a>
            </li>

            {{-- ── SISTEM UTAMA (SUPERADMIN) ──────────────────────────────────── --}}
            @if ($role === 'superadmin')
                <li class="{{ $sectionLabel }}" x-show="!collapsed" x-cloak>Sistem Utama</li>
                ...
                <li>
                    <a href="{{ route('superadmin.users.index') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Data Pengguna</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('superadmin.portfolios.index') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Portofolio</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.promo_events.index') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Promo Event</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('superadmin.articles.index') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Manajemen Blog</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('superadmin.settings') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Pengaturan Sistem</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('superadmin.backup.index') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Sistem Backup</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('superadmin.withdrawals.index') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Kelola Penarikan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('superadmin.finance') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Laporan Keuangan</span>
                    </a>
                </li>
            @endif
            ...
            {{-- ── MANAJEMEN JOKI ──────────────────────────────────────────────── --}}
            @if ($isAdminJoki)
                <li class="{{ $sectionLabel }}" x-show="!collapsed" x-cloak>Manajemen Joki</li>
                ...
                <li>
                    <a href="{{ route('admin_joki.orders') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Kelola Pesanan Joki</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_joki.services.index') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Manajemen Layanan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_joki.finance') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Keuangan Joki</span>
                    </a>
                </li>
            @endif
            ...
            {{-- ── MANAJEMEN HOSTING ───────────────────────────────────────────── --}}
            @if ($isAdminHosting)
                <li class="{{ $sectionLabel }}" x-show="!collapsed" x-cloak>Manajemen Hosting</li>
                ...
                <li>
                    <a href="{{ route('admin_hosting.projects') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Kelola Project</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.deployments') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Riwayat Deploy</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.pending') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Butuh Tindakan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.databases') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Semua Database</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.storage') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Limit Penyimpanan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.billing') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Kelola Tagihan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.vouchers.index') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Kelola Voucher</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin_hosting.tickets.index') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Kelola Tiket</span>
                    </a>
                </li>
            @endif
            ...
            {{-- ── LAYANAN KLIEN JOKI ──────────────────────────────────────────── --}}
            @if ($isUserJoki)
                <li class="{{ $sectionLabel }}" x-show="!collapsed" x-cloak>Layanan Joki</li>
                ...
                <li>
                    <a href="{{ route('user_joki.create') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Buat Pesanan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_joki.progress') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Progres Pengerjaan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_joki.riwayat') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Riwayat Selesai</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_joki.billing') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Riwayat Tagihan</span>
                    </a>
                </li>
            @endif
            ...
            @if ($isUserHosting)
                <li class="{{ $sectionLabel }}" x-show="!collapsed" x-cloak>Hosting</li>
                ...
                <li>
                    <a href="{{ route('user_hosting.marketplace') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Deploy Aplikasi</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.apk.index') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Web to APK</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.tunnels.index') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Local Tunnels</span>
                        <span
                            ...
                            x-show="!collapsed" x-cloak>Beta</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.templates') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Galeri Template</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.projects') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Proyek Aktif</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.databases') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Database</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.databases.pma') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>DB Manager</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.storage') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>File & Storage</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.docs') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Dokumentasi</span>
                    </a>
                </li>

                <li class="{{ $sectionLabel }} mt-4" x-show="!collapsed" x-cloak>Akun</li>
                ...
                <li>
                    <a href="{{ route('user_hosting.subscription') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Langganan Paket</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_hosting.tickets.index') }}"
                        ...
                        <span class="ms-3" x-show="!collapsed" x-cloak>Pusat Bantuan</span>
                    </a>
                </li>
            @endif
        </ul>
        ...
        <div class="mt-auto pt-6 border-t border-gray-100 dark:border-gray-800">
            <div class="flex items-center px-2 py-2" :class="collapsed ? 'justify-center' : 'justify-between'">
                <span class="text-[10px] font-bold text-gray-400 dark:text-gray-600 uppercase tracking-widest"
                    x-show="!collapsed" x-cloak>Ryaze Portal</span>
                <span
                    ...
                    <span x-show="!collapsed" x-cloak>{{ $appVersion }}</span>
                </span>
            </div>
        </div>
    </div>
