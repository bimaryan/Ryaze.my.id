...
<div
    class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col justify-between group transition-all duration-300 hover:shadow-md {{ $palette['hover_border'] }} hover:-translate-y-1 relative overflow-hidden">
    <div
