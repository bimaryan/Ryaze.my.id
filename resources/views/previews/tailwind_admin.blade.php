...
<body class="bg-slate-50 dark:bg-slate-800/50 font-sans antialiased text-slate-800 dark:text-slate-100 h-screen flex overflow-hidden selection:bg-primary selection:text-white">
        ...
        <div class="flex-1 overflow-y-auto py-8 flex flex-col gap-8 scrollbar-hide">
            <div class="px-6">
                ...
                <nav class="space-y-1.5">
                    ...
                    <a href="#" class="text-slate-400 hover:bg-white dark:bg-slate-800/5 hover:text-white px-4 py-3 rounded-xl flex items-center gap-3 text-sm font-medium transition">
            ...
            <div class="px-6">
                ...
                <nav class="space-y-1.5">
                    <a href="#" class="text-slate-400 hover:bg-white dark:bg-slate-800/5 hover:text-white px-4 py-3 rounded-xl flex items-center gap-3 text-sm font-medium transition flex justify-between">
    ...
    <!-- Main Content -->
    <div class="flex-1 flex flex-col w-full h-full min-w-0 bg-slate-50 dark:bg-slate-800/50">
        
        <!-- Top Header -->
        <header class="h-20 bg-white dark:bg-slate-800 shadow-sm border-b border-slate-200 flex items-center justify-between px-6 lg:px-10 z-10 flex-shrink-0">
            <div class="flex items-center gap-6">
                <button class="lg:hidden text-slate-500 hover:text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-700/50 w-10 h-10 rounded-xl flex items-center justify-center">
                    <i class="fa-solid fa-bars text-lg"></i>
                </button>
                <div class="relative hidden md:block">
                    <i class="fa-solid fa-magnifying-glass absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-sm"></i>
                    <input type="text" placeholder="Search orders, customers..." class="pl-11 pr-4 py-2.5 bg-slate-100 border-transparent rounded-xl text-sm font-medium focus:bg-white dark:bg-slate-800 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none w-80 transition-all shadow-sm">
                </div>
            </div>
            ...
            <div class="flex items-center gap-5">
                ...
                <div class="flex items-center gap-3 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700/40 dark:bg-slate-800/50 p-1.5 rounded-xl transition pr-3">
                    ...
                    <div class="hidden md:block text-sm text-left">
                        <p class="font-bold text-slate-800 dark:text-slate-100 leading-none mb-1">Jane Doe</p>
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-6 lg:p-10">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-end mb-8 gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-slate-900 dark:text-slate-100 tracking-tight">Dashboard Overview</h1>
                    <p class="text-slate-500 mt-2 font-medium">Welcome back, Jane! Here's what's happening today.</p>
                </div>
                <div class="flex gap-3">
                    <button class="bg-white dark:bg-slate-800 border border-slate-200 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700/40 px-4 py-2.5 rounded-xl text-sm font-semibold shadow-sm transition flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <!-- Card 1 -->
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 p-6 relative overflow-hidden group hover:border-primary/30 transition">
                    ...
                    <p class="text-3xl font-black text-slate-900 dark:text-slate-100">12,543</p>
                </div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 p-6 relative overflow-hidden group hover:border-primary/30 transition">
                    ...
                    <p class="text-3xl font-black text-slate-900 dark:text-slate-100">8,234</p>
                </div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 p-6 relative overflow-hidden group hover:border-primary/30 transition">
                    ...
                    <p class="text-3xl font-black text-slate-900 dark:text-slate-100">$124.5K</p>
                </div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 p-6 relative overflow-hidden group hover:border-primary/30 transition">
                    ...
                    <p class="text-3xl font-black text-slate-900 dark:text-slate-100">1.2M</p>
                </div>
            </div>

            <!-- Table -->
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                <div class="px-6 py-6 border-b border-slate-200 flex justify-between items-center bg-white dark:bg-slate-800">
                    <h2 class="text-lg font-bold text-slate-900 dark:text-slate-100">Recent Transactions</h2>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm text-slate-600 dark:text-slate-300 whitespace-nowrap">
                        <thead class="bg-slate-50 dark:bg-slate-800/50/80 text-slate-500 font-bold text-xs uppercase tracking-wider border-b border-slate-200">
                            <tr>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/40 dark:bg-slate-800/50/80 transition group">
                                <td class="px-6 py-4 font-mono text-slate-900 dark:text-slate-100 font-medium">#ORD-001</td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="w-8 h-8 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center font-bold text-xs">JD</div>
                                        <span class="font-bold text-slate-900 dark:text-slate-100">John Doe</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 font-medium text-slate-500">Oct 12, 2026</td>
                                <td class="px-6 py-4 font-bold text-slate-900 dark:text-slate-100">$129.00</td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <button class="text-slate-400 hover:text-primary transition p-2 bg-slate-50 dark:bg-slate-800/50 rounded-lg opacity-0 group-hover:opacity-100"><i class="fa-solid fa-ellipsis-vertical"></i></button>
                                </td>
                            </tr>
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/40 dark:bg-slate-800/50/80 transition group">
                                <td class="px-6 py-4 font-mono text-slate-900 dark:text-slate-100 font-medium">#ORD-002</td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="w-8 h-8 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center font-bold text-xs">AS</div>
                                        <span class="font-bold text-slate-900 dark:text-slate-100">Alice Smith</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 font-medium text-slate-500">Oct 12, 2026</td>
                                <td class="px-6 py-4 font-bold text-slate-900 dark:text-slate-100">$89.50</td>
                                <td class="px-6 py-4">
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/40 dark:bg-slate-800/50/80 transition group">
                                <td class="px-6 py-4 font-mono text-slate-900 dark:text-slate-100 font-medium">#ORD-003</td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="w-8 h-8 rounded-full bg-red-100 text-red-600 flex items-center justify-center font-bold text-xs">BJ</div>
                                        <span class="font-bold text-slate-900 dark:text-slate-100">Bob Johnson</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 font-medium text-slate-500">Oct 11, 2026</td>
                                <td class="px-6 py-4 font-bold text-slate-900 dark:text-slate-100">$249.99</td>
                                <td class="px-6 py-4">
