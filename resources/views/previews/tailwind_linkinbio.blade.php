...
<body class="bg-animated min-h-screen font-sans antialiased flex flex-col items-center py-10 px-4 sm:px-6 selection:bg-white dark:bg-slate-800 selection:text-pink-500">
    
    <!-- Share Button -->
    <div class="absolute top-6 right-6">
        <button class="w-10 h-10 rounded-full glass-card text-white flex items-center justify-center hover:bg-white dark:bg-slate-800/30 transition shadow-lg backdrop-blur-md">
    ...
    <div class="w-full max-w-[440px] glass-card rounded-[3rem] p-8 sm:p-10 shadow-2xl relative mt-8">
        ...
        <div class="text-center mb-10 relative">
            <div class="w-32 h-32 mx-auto bg-white dark:bg-slate-800/20 p-2 rounded-full shadow-2xl mb-6 relative backdrop-blur-sm border border-white/30">
            ...
            <div class="flex justify-center gap-3">
                <a href="#" class="w-11 h-11 rounded-full glass-card text-white flex items-center justify-center text-lg hover:bg-white dark:bg-slate-800 hover:text-pink-500 transition-all hover:scale-110 shadow-md"><i class="fa-brands fa-instagram"></i></a>
                <a href="#" class="w-11 h-11 rounded-full glass-card text-white flex items-center justify-center text-lg hover:bg-white dark:bg-slate-800 hover:text-blue-400 transition-all hover:scale-110 shadow-md"><i class="fa-brands fa-twitter"></i></a>
                <a href="#" class="w-11 h-11 rounded-full glass-card text-white flex items-center justify-center text-lg hover:bg-white dark:bg-slate-800 hover:text-red-500 transition-all hover:scale-110 shadow-md"><i class="fa-brands fa-youtube"></i></a>
                <a href="#" class="w-11 h-11 rounded-full glass-card text-white flex items-center justify-center text-lg hover:bg-white dark:bg-slate-800 hover:text-black dark:text-white transition-all hover:scale-110 shadow-md"><i class="fa-brands fa-tiktok"></i></a>
                <a href="#" class="w-11 h-11 rounded-full glass-card text-white flex items-center justify-center text-lg hover:bg-white dark:bg-slate-800 hover:text-blue-600 transition-all hover:scale-110 shadow-md"><i class="fa-brands fa-linkedin-in"></i></a>
            </div>
        </div>

        <!-- Links -->
        <div class="space-y-4">
            <a href="#" class="btn-link block w-full text-slate-800 dark:text-slate-100 text-center font-bold py-4 px-6 rounded-2xl shadow-xl transition-all duration-300 relative group overflow-hidden border border-white/50">
