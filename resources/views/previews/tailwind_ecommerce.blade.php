...
<body class="bg-white dark:bg-slate-800 font-sans antialiased text-slate-900 dark:text-slate-100 selection:bg-accent selection:text-white overflow-x-hidden">
    <!-- Topbar -->
    <div class="bg-brand text-white text-xs font-semibold text-center py-2.5 tracking-wide">
        Diskon Hingga 50% untuk Pengguna Baru! Gunakan kode: <span class="font-black text-accent ml-1 px-2 py-0.5 bg-white dark:bg-slate-800/10 rounded">NEW50</span>
    </div>

    <!-- Navbar -->
    <nav class="bg-white dark:bg-slate-800 border-b border-slate-100 sticky top-0 z-50 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex space-x-10">
                    <a href="#" class="text-slate-900 dark:text-slate-100 font-bold border-b-2 border-brand py-1">Pria</a>
                    <a href="#" class="text-slate-500 hover:text-slate-900 dark:text-slate-100 font-medium py-1 transition">Wanita</a>
                    <a href="#" class="text-slate-500 hover:text-slate-900 dark:text-slate-100 font-medium py-1 transition">Anak</a>
    ...
    <main>
        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="bg-slate-100 dark:bg-slate-700/50 rounded-[2rem] overflow-hidden relative shadow-xl">
                ...
                <div class="relative z-20 h-[500px] flex items-center px-8 md:px-16 w-full max-w-2xl">
                    <div>
                        ...
                        <a href="#" class="inline-flex items-center gap-3 bg-white dark:bg-slate-800 text-brand font-bold px-8 py-4 rounded-full hover:bg-slate-100 dark:hover:bg-slate-700/50 hover:scale-105 transition-all shadow-xl text-lg group">
        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-12">
                ...
                <div class="group relative cursor-pointer">
                    <div class="w-full aspect-[3/4] bg-slate-100 dark:bg-slate-700/50 rounded-3xl overflow-hidden relative mb-5 shadow-sm group-hover:shadow-xl transition-shadow duration-500">
                        ...
                        <div class="absolute top-4 left-4 flex flex-col gap-2 z-10">
                            <span class="bg-white dark:bg-slate-800 text-brand text-[10px] font-black tracking-widest px-3 py-1.5 rounded-md shadow-md uppercase">BARU</span>
                        </div>
                        <!-- Hover Overlay -->
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            <h3 class="font-bold text-lg text-slate-900 dark:text-slate-100 group-hover:text-accent transition truncate">Essential Premium T-Shirt</h3>
                            <p class="text-sm font-medium text-slate-500">Kapas Organik</p>
                        </div>
                    </div>
                    <p class="font-black text-xl text-slate-900 dark:text-slate-100 mt-2">Rp 250.000</p>
                </div>
                ...
                <div class="group relative cursor-pointer">
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            <h3 class="font-bold text-lg text-slate-900 dark:text-slate-100 group-hover:text-accent transition truncate">Classic Denim Jeans</h3>
                ...
                <div class="group relative cursor-pointer">
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            <h3 class="font-bold text-lg text-slate-900 dark:text-slate-100 group-hover:text-accent transition truncate">Waterproof Jacket</h3>
                            <p class="text-sm font-medium text-slate-500">Outerwear</p>
                        </div>
                    </div>
                    <p class="font-black text-xl text-slate-900 dark:text-slate-100 mt-2">Rp 750.000</p>
                </div>
                ...
                <div class="group relative cursor-pointer">
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            <h3 class="font-bold text-lg text-slate-900 dark:text-slate-100 group-hover:text-accent transition truncate">Retro Sneakers</h3>
                            <p class="text-sm font-medium text-slate-500">Sepatu</p>
                        </div>
                    </div>
                    <p class="font-black text-xl text-slate-900 dark:text-slate-100 mt-2">Rp 890.000</p>
                </div>
            </div>
        </section>
        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 mb-10">
            <div class="bg-brand rounded-[2.5rem] p-10 md:p-16 text-center text-white flex flex-col items-center relative overflow-hidden shadow-2xl">
                ...
                <a href="#" class="bg-white dark:bg-slate-800 text-brand font-bold px-10 py-4 rounded-full hover:bg-slate-100 dark:hover:bg-slate-700/50 transition hover:scale-105 shadow-xl relative z-10">Cek Info Detail</a>
            </div>
        </section>
    </main>

    <!-- Footer -->
    <footer class="bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div class="col-span-1 md:col-span-2">
                <div class="flex items-center gap-2 mb-6">
                    ...
                    <span class="text-xl font-black tracking-tighter uppercase text-slate-900 dark:text-slate-100">Ecommerce</span>
                </div>
                ...
                <div class="flex gap-3">
                    <div class="w-12 h-8 bg-white dark:bg-slate-800 shadow-sm border border-slate-200 rounded flex items-center justify-center text-brand"><i class="fa-brands fa-cc-visa text-xl"></i></div>
                    <div class="w-12 h-8 bg-white dark:bg-slate-800 shadow-sm border border-slate-200 rounded flex items-center justify-center text-brand"><i class="fa-brands fa-cc-mastercard text-xl"></i></div>
                    <div class="w-12 h-8 bg-white dark:bg-slate-800 shadow-sm border border-slate-200 rounded flex items-center justify-center text-brand"><i class="fa-brands fa-cc-paypal text-xl"></i></div>
                </div>
            </div>
            <div>
                <h4 class="font-bold text-slate-900 dark:text-slate-100 mb-6 text-lg">Bantuan</h4>
            ...
            <div>
                <h4 class="font-bold text-slate-900 dark:text-slate-100 mb-6 text-lg">Perusahaan</h4>
                <ul class="space-y-4 text-slate-500 font-medium">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex gap-4">
                <a href="#" class="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border border-slate-200 flex items-center justify-center text-slate-500 hover:text-accent hover:border-accent transition shadow-sm"><i class="fa-brands fa-instagram"></i></a>
                <a href="#" class="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border border-slate-200 flex items-center justify-center text-slate-500 hover:text-accent hover:border-accent transition shadow-sm"><i class="fa-brands fa-twitter"></i></a>
                <a href="#" class="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border border-slate-200 flex items-center justify-center text-slate-500 hover:text-accent hover:border-accent transition shadow-sm"><i class="fa-brands fa-facebook-f"></i></a>
            </div>
        </div>
    </footer>
</body>
