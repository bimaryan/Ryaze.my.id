...
@section('content')
    <x-ui.page-layout>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            {{-- Tailwind Portfolio --}}
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 group flex flex-col h-full overflow-hidden relative">
                <div class="absolute top-4 right-4 text-xs font-black bg-cyan-100 text-cyan-700 px-2.5 py-1 rounded-full z-10 uppercase tracking-wide">DESIGN TEMPLATE</div>
                <div class="p-6 pb-0 flex-1 relative z-10">
