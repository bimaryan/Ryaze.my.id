                ...
                <form action="{{ route('user_hosting.storage.upgrade') }}" method="POST" class="mt-6 pt-5 border-t border-slate-100">
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div class="flex-1 w-full max-w-sm">
                            ...
                            <p class="text-xs text-slate-500 mt-0.5 mb-2">Upgrade storage Anda 1GB tambahan hanya dengan Rp 15.000.</p>
                            <input type="text" name="voucher_code" placeholder="Kode Voucher (Opsional)" class="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors">
                        </div>
                        <button type="submit" class="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 px-5 py-2.5 rounded-lg text-sm font-semibold transition shrink-0">
