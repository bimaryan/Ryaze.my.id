                ...
                <div class="bg-white dark:bg-slate-800/60 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <label class="relative cursor-pointer flex-1 group">
                            ...
                            <div class="h-full px-5 py-4 border-2 border-slate-200 dark:border-slate-700 rounded-xl peer-checked:border-indigo-600 peer-checked:bg-indigo-50 dark:peer-checked:bg-indigo-900/30 hover:border-slate-300 dark:hover:border-slate-600 transition-all flex items-center gap-4">
                            ...
                            @foreach($availableFrameworks as $index => $fw)
                                ...
                                @else
                                    <label class="relative cursor-pointer">
                                        ...
                                        <div class="p-3 border-2 border-slate-200 dark:border-slate-700 rounded-xl peer-checked:border-indigo-600 peer-checked:bg-indigo-50 dark:peer-checked:bg-indigo-900/30 hover:border-slate-300 dark:hover:border-slate-600 transition-all text-center">
...
(function() {
    ...
    if (uploadInput) {
        ...
        ['dragover', 'dragenter'].forEach(evt => {
            ...
            uploadZone.classList.remove('border-slate-300', 'dark:border-slate-600');
            });
        });
