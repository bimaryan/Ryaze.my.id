                        ...
                        <div class="bg-indigo-50/50 rounded-xl p-3 border border-indigo-100">
                            ...
                            <div class="space-y-2 text-sm">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-mono bg-white text-slate-700 px-1.5 py-0.5 rounded border border-slate-200">{{ $user->db_host ?? 'localhost' }}:{{ $user->db_port ?? 3306 }}</span>
                                </div>
                            </div>
                        </div>
                    </td>
            ...
            <div class="modal-content-stop bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden relative">
                ...
                <form action="{{ route('admin_hosting.databases.store') }}" method="POST">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1">Nama Database <span class="text-rose-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1">Username Database <span class="text-slate-400 font-normal">(opsional)</span></label>
                            <div class="flex rounded-xl overflow-hidden border border-slate-300 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/20 transition-all">
                                <span class="prefix-addon inline-flex items-center px-3 bg-slate-100 text-slate-500 text-sm font-mono border-r border-slate-300 whitespace-nowrap">
                                    ryz_.._
                                </span>
                            ...
                            <p class="text-[11px] text-slate-500 mt-1">Kosongkan username & password jika klien sudah memiliki database sebelumnya.</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1">Password Database <span class="text-slate-400 font-normal">(opsional)</span></label>
                            <div class="flex rounded-xl overflow-hidden border border-slate-300 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/20 transition-all">
                                <span class="prefix-addon inline-flex items-center px-3 bg-slate-100 text-slate-500 text-sm font-mono border-r border-slate-300 whitespace-nowrap">
                                    ryz_.._
                                </span>
