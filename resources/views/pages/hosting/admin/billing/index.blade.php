...
@section('content')
    <x-ui.page-layout>
        ...
        <div
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 mt-0.5">Verifikasi pembayaran dan pantau seluruh tagihan hosting
                        pengguna.</p>
                </div>
            </div>
        </div>
        ...
        <div id="verifyModal"
            ...
            <div
                class="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden scale-95 transition-transform duration-300 transform">
                <div class="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                    <h3 class="text-lg font-bold text-slate-800">Update Status Tagihan</h3>
                    <button type="button"
                        class="btn-close-verify text-slate-400 hover:text-rose-500 transition-colors p-2 rounded-lg hover:bg-rose-50">
                ...
                <form id="verifyForm" method="POST">
                    ...
                    @method('PUT')
                    <div class="p-6">
                        <p class="text-sm text-slate-500 mb-4">Ubah status untuk tagihan <strong id="verify_invoice"
                    ...
                    <div class="p-6 border-t border-slate-100 bg-slate-50 flex justify-end gap-3">
                        <button type="button"
                            class="btn-close-verify px-5 py-2.5 text-sm font-medium text-slate-600 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors">
                            Batal
                        </button>
                        <button type="submit"
