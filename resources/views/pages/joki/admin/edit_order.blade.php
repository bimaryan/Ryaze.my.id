        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div class="xl:col-span-2 space-y-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                    ...
                    <form action="{{ route('admin_joki.orders.update', $order->id) }}" method="POST" class="space-y-4">
                        @csrf
                        @method('PUT')
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                    ...
                    <form action="{{ route('admin_joki.milestone.store', $order->id) }}" method="POST"
                    ...
                    <div class="space-y-4">
                        @forelse($order->revisions as $rev)
                            <div
                                ...
                                <form action="{{ route('admin_joki.revision.reply', $rev->id) }}" method="POST"
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                    ...
                    <form action="{{ route('admin_joki.payment.store', $order->id) }}" method="POST"
                                ...
                                @if ($payment->proof_image)
                                    <div class="mt-3 pt-3 border-t border-slate-100">
                                        ...
                                        @if ($payment->status == 'pending_verification')
                                            <form action="{{ route('admin_joki.payment.verify', $payment->id) }}"
