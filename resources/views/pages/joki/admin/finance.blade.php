...
@section('content')
    <x-ui.page-layout>
        ...
        <x-ui.table>
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/40 transition-colors">
                    ...
                    <td class="px-6 py-4 font-bold text-slate-800 dark:text-slate-100">
                        <a href="{{ route('admin_joki.orders.edit', $payment->order->hashid) }}"
                            class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-400">
                    ...
                    <td class="px-6 py-4 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">
            ...
            @empty
                <tr>
                    <td colspan="5" class="px-6 py-10 text-center text-slate-400 dark:text-slate-500">Belum ada pendapatan yang tercatat.
                    </td>
                </tr>
            @endforelse
        </x-ui.table>
