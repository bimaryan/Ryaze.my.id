        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm p-6">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $article->title) }}" required
                            class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-100 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-3">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="excerpt" id="excerpt" rows="3"
                            class="text-slate-800 dark:text-slate-100 block p-3 w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition">{{ old('excerpt', $article->excerpt) }}</textarea>
                    ...
                    <div class="mb-5">
                        ...
                        <div id="editor-container" class="bg-white dark:bg-slate-800/60 rounded-b-lg border-x border-b border-slate-200 dark:border-slate-700 prose prose-sm max-w-none" style="height: 500px;">{!! old('body', $article->body) !!}</div>
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm p-6">
                    ...
                    <div class="text-xs text-slate-400 dark:text-slate-500 mb-5 space-y-1">
                ...
                <div class="bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm p-6">
                    ...
                    @if($article->cover_image)
                        <img src="{{ Storage::url($article->cover_image) }}" alt="Cover" class="w-full h-40 object-cover rounded-lg border border-slate-200 dark:border-slate-700 mb-3">
                    @endif
                    ...
                    <p class="text-xs text-slate-400 dark:text-slate-500 mt-2">Kosongkan jika tidak ingin mengubah.</p>
                </div>
                ...
                <div class="bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm p-6">
                    ...
                    <input type="text" name="tags" value="{{ old('tags', is_array($article->tags) ? implode(', ', $article->tags) : $article->tags) }}"
                        class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-100 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-3" placeholder="laravel, php, tutorial">
