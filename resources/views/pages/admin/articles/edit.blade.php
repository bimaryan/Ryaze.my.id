                ...
                <div class="bg-white border border-slate-200 rounded-xl shadow-sm p-6">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="body" id="body" rows="20"
                            class="bg-white border border-slate-200 text-slate-800 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-3">{{ old('body', $article->body) }}</textarea>
...
<script src="https://cdn.tiny.cloud/1/no-api-key/tinymce/6/tinymce.min.js" referrerpolicy="origin" nonce="{{ app('csp_nonce') ?? '' }}"></script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        if (typeof tinymce !== 'undefined') {
            tinymce.init({
                ...
                toolbar: 'undo redo | blocks | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image codesample | removeformat | help',
