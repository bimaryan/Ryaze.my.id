                ...
                <div class="bg-white border border-slate-200 rounded-xl shadow-sm p-6">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="body" id="body" rows="20"
                            class="bg-white border border-slate-200 text-slate-800 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-3">{{ old('body') }}</textarea>
