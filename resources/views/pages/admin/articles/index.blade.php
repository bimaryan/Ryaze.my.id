        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-4 px-1 gap-4">
            ...
            <form action="{{ route('superadmin.articles.index') }}" method="GET" class="flex items-center w-full sm:w-auto">
                ...
                <div class="relative w-full sm:w-64">
                    ...
                    <input type="text" name="search" class="bg-white border border-slate-200 text-slate-800 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full ps-9 p-2 shadow-sm" placeholder="Cari judul artikel..." value="{{ request('search') }}">
                </div>
