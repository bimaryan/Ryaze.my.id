...
@section('content')
    <x-ui.page-layout>
        <x-ui.page-header 
            ...
            subtitle="Tambahkan sertifikat atau lisensi baru." 
        ...
        <x-ui.card class="w-full mt-6">
            <form action="{{ route('superadmin.certifications.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Contoh: AWS Certified Solutions Architect"
                        ...
                        <div>
                            ...
                            <input type="text" name="issuer" id="issuer" value="{{ old('issuer') }}" placeholder="Contoh: Amazon Web Services"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="credential_id" id="credential_id" value="{{ old('credential_id') }}" placeholder="Contoh: AWS-SA-123456"
