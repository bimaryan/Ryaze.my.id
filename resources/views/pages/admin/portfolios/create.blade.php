...
@section('content')
    <x-ui.page-layout>
        <x-ui.page-header 
            ...
            subtitle="Tambahkan data portofolio/mahakarya baru." 
            ...
            <form action="{{ route('superadmin.portfolios.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="title" id="title" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none text-sm transition-all @error('title') border-red-500 @enderror" value="{{ old('title') }}" required>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="5" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none text-sm transition-all @error('description') border-red-500 @enderror" required>{{ old('description') }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" name="tags" id="tags" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none text-sm transition-all @error('tags') border-red-500 @enderror" value="{{ old('tags') }}" placeholder="Contoh: Laravel, Tailwind, React">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="url" name="link_preview" id="link_preview" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none text-sm transition-all @error('link_preview') border-red-500 @enderror" value="{{ old('link_preview') }}" placeholder="https://...">
