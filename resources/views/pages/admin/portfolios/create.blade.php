            ...
            <form action="{{ route('superadmin.portfolios.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="title" id="title" class="transition-all @error('title') border-red-500 @enderror w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition" value="{{ old('title') }}" required>
