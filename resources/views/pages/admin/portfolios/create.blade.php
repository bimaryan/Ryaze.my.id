            ...
            <form action="{{ route('superadmin.portfolios.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">Format: JPG, PNG, WEBP (Max 2MB). Kosongkan jika tidak ada.</p>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">Format: PDF, JPG, PNG (Max 5MB). Kosongkan jika tidak ada.</p>
