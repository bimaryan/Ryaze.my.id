...
@section('content')
    <main class="flex-grow flex items-center justify-center pt-24 pb-16 px-6">
        <div class="w-full max-w-2xl text-center">
            ...
            <h1 class="text-7xl md:text-9xl font-black text-slate-900 dark:text-slate-50 tracking-tighter mb-4">401</h1>
            <h2 class="text-2xl md:text-3xl font-bold text-slate-800 dark:text-slate-100 mb-4">Unauthorized</h2>
            <p class="text-base md:text-lg text-slate-500 dark:text-slate-400 mb-10 max-w-lg mx-auto leading-relaxed">Maaf, Anda tidak memiliki akses yang sah untuk melihat halaman ini. Silakan login kembali.</p>
