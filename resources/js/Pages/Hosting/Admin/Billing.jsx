                            ...
                            <tbody className="divide-y divide-[#e5e5e5] dark:divide-[#1a1a2e]">
                                {payments?.data?.length > 0 ? payments.data.map((p) => (
                                    <tr key={p.id} className="hover:bg-[#fafafa] dark:hover:bg-white/[0.02] transition-colors">
                                        <td className="px-5 py-3 text-[13px] text-[#333] dark:text-white">{p.user?.name || '-'}</td>
                                        <td className="px-5 py-3 text-[13px] text-[#666] dark:text-white/60">{p.project?.name || '-'}</td>
                                        <td className="px-5 py-3 text-[13px] font-mono text-[#666] dark:text-white/60">{p.invoice_number || '-'}</td>
