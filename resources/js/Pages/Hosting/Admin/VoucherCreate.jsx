...
export default function VoucherCreate() {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        post(route('admin_hosting.vouchers.store'));
    }

    return (
        <DashboardLayout title="Tambah Voucher Baru">
            <div className="mb-1">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-bold text-[#333] dark:text-white">Tambah Voucher Baru</h1>
                            <p className="text-[13px] text-[#999] dark:text-white/40">Buat voucher diskon baru untuk klien hosting.</p>
                        </div>
                    </div>
                    <Link
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            required
                            placeholder="Misal: GRATIS1BULAN"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                                placeholder="Misal: 10000 atau 100"
                                className="w-full bg-[#fafafa] dark:bg-[#0d0d18] border border-[#e5e5e5] dark:border-[#1a1a2e] rounded-xl px-4 py-2.5 text-sm text-[#333] dark:text-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition"
                            />
                            <p className="text-xs text-[#999] dark:text-white/40 mt-1">Isi 100 untuk menggratiskan secara penuh jika tipe diskon adalah Persentase.</p>
