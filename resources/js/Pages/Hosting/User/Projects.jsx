        ...
        <DashboardLayout title="My Projects">
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <p className="text-[13px] text-[#666] dark:text-white/60">{projects?.total || 0} projects</p>
                    <Link href="/user/hosting/create" className="px-4 py-2 bg-[#7c3aed] text-white text-[13px] font-semibold hover:bg-[#6d28d9] transition-colors">
                        <i className="fa-solid fa-plus mr-1.5"></i>New Project
                    </Link>
                </div>
                                ...
                                {projects?.data?.length > 0 ? projects.data.map((project) => (
                                    <tr key={project.id} className="hover:bg-[#fafafa] dark:hover:bg-white/[0.02] transition-colors">
                                        <td className="px-5 py-3">
                                            <Link href={`/user/hosting/projects/${project.id}`} className="text-[13px] font-semibold text-[#333] dark:text-white hover:text-[#7c3aed] dark:hover:text-[#a78bfa] transition-colors">
                                                {project.name}
                                            </Link>
                                        </td>
                                        ...
                                        <td className="px-5 py-3 text-right">
                                            <Link href={`/user/hosting/projects/${project.id}`} className="text-[12px] text-[#7c3aed] hover:text-[#6d28d9] font-medium transition-colors">
                                    ...
                                    <tr>
                                        <td colSpan="5" className="px-5 py-12 text-center">
                                            <i className="fa-solid fa-server text-3xl text-[#e5e5e5] dark:text-white/10 mb-3 block"></i>
                                            <p className="text-[13px] text-[#999] dark:text-white/40 mb-3">No projects yet</p>
                                            <Link href="/user/hosting/create" className="text-[13px] text-[#7c3aed] hover:text-[#6d28d9] font-medium transition-colors">
