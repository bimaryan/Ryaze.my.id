        ...
        <PublicLayout title="Jasa Pembuatan Website & Shared Hosting Indonesia" description="Platform hosting & development modern.">
                ...
                <div className="relative max-w-6xl mx-auto px-6 pt-32 pb-28 lg:pt-44 lg:pb-36">
                    <div className="max-w-3xl" data-reveal>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <a href="#pricing" className="px-7 py-3 bg-[#7c3aed] text-white text-sm font-semibold hover:bg-[#6d28d9] transition-colors text-center">
                                Lihat Paket
                            </a>
                            <a href="#services" className="px-7 py-3 border border-[#ddd] text-[#1a1025] text-sm font-semibold hover:border-[#7c3aed] hover:text-[#7c3aed] transition-colors text-center">
                                Pelajari Lebih Lanjut
                            </a>
                        </div>
                    </div>

                    <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-px bg-[#e5e5e5] border border-[#e5e5e5]" data-reveal>
                        {[
                    ...
                    <div className="mt-16 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8" data-reveal>
                        <span className="text-[10px] font-bold text-[#bbb] uppercase tracking-[0.2em] shrink-0">Tech Stack</span>
                        <div className="flex flex-wrap gap-4 sm:gap-6 text-[#ccc]">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
                        ...
                        <div className="lg:col-span-7 lg:pt-8" data-reveal>
                            <div className="border border-[#e5e5e5] bg-[#fafafa]">
                                ...
                                <div className="border-t border-[#e5e5e5] px-8 py-4 flex flex-wrap items-center gap-4 text-xs text-[#999]">
            ...
            <section id="services" className="bg-[#fafafa]">
                <div className="max-w-6xl mx-auto px-6 py-24 lg:py-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#e5e5e5] border border-[#e5e5e5]" data-reveal>
            ...
            <section id="pricing" className="bg-white border-y border-[#e5e5e5]">
                <div className="max-w-6xl mx-auto px-6 py-24 lg:py-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-[#e5e5e5] border border-[#e5e5e5] mb-16" data-reveal>
                        {activePlans.map(([slug, plan]) => {
                            const p = planPricing[slug];
                            const pop = slug === 'pro';
                            return (
                                <div key={slug} className={`${pop ? 'bg-[#1a1025] text-white border-[#2d1f42]' : 'bg-white border-[#e5e5e5]'} p-8 flex flex-col relative`}>
                                    ...
                                    <a href="/register" className={`mt-8 flex items-center justify-center w-full py-2.5 text-sm font-semibold transition-colors ${pop ? 'bg-white text-[#1a1025] hover:bg-slate-100' : 'bg-[#1a1025] text-white hover:bg-[#2d1f42]'}`}>
                                        Pilih Paket
                                    </a>
                                </div>
                            );
            ...
            <section id="blog" className="bg-[#fafafa]">
                <div className="max-w-6xl mx-auto px-6 py-24 lg:py-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-[#e5e5e5] border border-[#e5e5e5]" data-reveal>
            ...
            <div className="fixed bottom-4 right-4 left-4 z-50 sm:bottom-6 sm:right-6 sm:left-auto">
                {chatOpen && (
                    <div className="bg-white border border-[#e5e5e5] shadow-2xl w-full max-w-sm sm:w-80 h-96 sm:h-96 mb-4 flex flex-col overflow-hidden">
                        ...
                        <div className="flex-1 p-4 overflow-y-auto space-y-3 bg-[#fafafa]">
                            ...
                            {chatMsgs.map(m => (
                                <div key={m.id} className={`flex items-start gap-2 ${m.user ? 'flex-row-reverse' : ''}`}>
                                    ...
                                    <div className={`px-3 py-2 text-sm max-w-[85%] ${m.user ? 'bg-[#7c3aed] text-white' : 'bg-white border border-[#e5e5e5] text-[#444]'}`}>{m.text}</div>
                                </div>
                            ))}
                            {chatLoading && (
                                <div className="flex items-start gap-2">
