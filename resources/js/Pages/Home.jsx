    ...
    return (
        <div className="border-b border-[#e5e5e5] dark:border-[#2d1f42]">
            <button onClick={() => setOpen(!open)} className="w-full flex items-center justify-between py-5 text-left group">
                <span className="text-[15px] font-medium text-[#7c3aed] dark:text-white group-hover:text-[#6d28d9] transition-colors">{q}</span>
                ...
                <div className="relative max-w-6xl mx-auto px-6 pt-32 pb-28 lg:pt-44 lg:pb-36">
                    <div className="max-w-3xl" data-reveal>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            ...
                            <a href="#services" className="px-7 py-3 border border-[#7c3aed] text-[#7c3aed] text-sm font-semibold hover:bg-[#7c3aed] hover:text-white transition-colors text-center">
                    ...
                    <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-px bg-[#e5e5e5] dark:bg-[#1a1a2e] border border-[#e5e5e5] dark:border-[#1a1a2e]" data-reveal>
                        {[
                            ...
                            <div key={i} className="bg-white dark:bg-[#0d0d18] px-6 py-8 text-center">
                                <p className="text-3xl font-black text-[#7c3aed] dark:text-white tracking-tight">{s.n}</p>
                ...
                <div className="max-w-6xl mx-auto px-6 py-24 lg:py-32">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
                        <div className="lg:col-span-5" data-reveal>
                            ...
                            <h2 className="text-4xl font-black text-[#7c3aed] dark:text-white tracking-tight leading-[1.1] mb-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {['AUTO DEPLOY', 'SSL GRATIS', 'MYSQL', 'TERMINAL'].map(t => (
                                    <span key={t} className="px-3 py-1 bg-[#f5f0ff] dark:bg-[#1a1025]/10 text-[#7c3aed] text-[11px] font-bold tracking-wider border border-[#e9e0ff] dark:border-[#7c3aed]/20">{t}</span>
                                ))}
                            </div>
                        </div>
                        <div className="lg:col-span-7 lg:pt-8" data-reveal>
                            <div className="border border-[#e5e5e5] dark:border-[#1a1a2e] bg-white dark:bg-[#0a0a14]">
                                <div className="border-b border-[#e5e5e5] dark:border-[#1a1a2e] px-8 py-6 flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-bold text-[#7c3aed] dark:text-white text-lg">Ryaze Hosting</h3>
                ...
                <div className="max-w-6xl mx-auto px-6 py-24 lg:py-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#e5e5e5] dark:bg-[#1a1a2e] border border-[#e5e5e5] dark:border-[#1a1a2e]" data-reveal>
                        <div className="bg-white dark:bg-[#0d0d18] p-8 lg:p-10 flex flex-col">
                            <div className="w-10 h-10 bg-[#7c3aed] flex items-center justify-center mb-8">
                                <i className="fa-solid fa-code text-white text-sm"></i>
                            </div>
                            <h3 className="text-2xl font-black text-[#7c3aed] dark:text-white mb-3">Jasa Pembuatan Sistem</h3>
                            ...
                            <a href="/consultation" className="inline-flex items-center justify-center px-6 py-2.5 border border-[#7c3aed] text-[#7c3aed] text-sm font-semibold hover:bg-[#7c3aed] hover:text-white transition-colors w-full sm:w-auto">
                                Mulai Konsultasi
                            </a>
                        </div>

                        <div className="bg-white dark:bg-[#0d0d18] p-8 lg:p-10 flex flex-col relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-[#f5f0ff] dark:bg-[#1a1025]/5 rounded-bl-[80px]"></div>
                ...
                <div className="max-w-6xl mx-auto px-6 py-24 lg:py-32">
                        ...
                        {activePlans.map(([slug, plan]) => {
                            ...
                            return (
                                <div key={slug} className={`${pop ? 'bg-[#7c3aed] dark:bg-[#6d28d9] text-white border-[#7c3aed] dark:border-[#3d2f52]' : 'bg-white dark:bg-[#0d0d18] border-[#e5e5e5] dark:border-[#1a1a2e]'} p-8 flex flex-col relative`}>
                                    {pop && <div className="bg-white text-[#7c3aed] text-[10px] font-bold tracking-widest uppercase text-center py-1.5 -mx-8 -mt-8 mb-6">Paling Populer</div>}
                                    <h3 className={`text-lg font-bold mb-4 ${pop ? 'text-white' : 'text-[#7c3aed] dark:text-white'}`}>{plan.label}</h3>
                                    <div className="mb-6">
                                        {p.promo !== null && <span className={`text-xs price-strike block mb-1 ${pop ? 'text-[#e9d5ff]' : 'text-[#999] dark:text-white/50'}`}>Rp {rupiah(p.normal)}</span>}
                                    ...
                                    <ul className="space-y-2.5 flex-1">
                                        {plan.features.map(f => (
                                            <li key={f} className={`flex items-start gap-2.5 text-[13px] ${pop ? 'text-white/80' : 'text-[#666] dark:text-white/60'}`}>
                                                <i className={`fa-solid fa-check text-[9px] mt-[5px] ${pop ? 'text-[#e9d5ff]' : 'text-[#7c3aed]'}`}></i>
                                                <span>{f}</span>
                                            </li>
                                        ))}
                                    </ul>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#e5e5e5] dark:bg-[#1a1a2e] border border-[#e5e5e5] dark:border-[#1a1a2e]" data-reveal>
                        {[
                            ...
                            <div key={f.l} className="bg-white dark:bg-[#0a0a14] flex items-center justify-center gap-3 py-5">
                                <i className={`fa-solid ${f.i} text-[#7c3aed] text-sm`}></i>
                                <span className="text-sm font-semibold text-[#7c3aed] dark:text-white">{f.l}</span>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto px-6 py-24 lg:py-32">
                    <div className="flex items-end justify-between mb-12" data-reveal>
                        <div>
                            ...
                            <h2 className="text-4xl font-black text-[#7c3aed] dark:text-white tracking-tight">Artikel Terbaru</h2>
                        </div>
                        ...
                        {articles.length > 0 ? articles.map(a => (
                            <a key={a.id} href={a.url} className="bg-white dark:bg-[#0d0d18] group">
                                ...
                                <div className="p-6">
                                    ...
                                    <h3 className="text-[15px] font-bold text-[#7c3aed] dark:text-white mt-2 mb-2 group-hover:text-[#6d28d9] transition-colors line-clamp-2">{a.title}</h3>
            ...
            {/* <div className="fixed bottom-4 right-4 left-4 z-50 sm:bottom-6 sm:right-6 sm:left-auto">
                {chatOpen && (
                    <div className="bg-white dark:bg-[#0d0d18] border border-[#e5e5e5] dark:border-[#1a1a2e] shadow-2xl w-full max-w-sm sm:w-80 h-96 sm:h-96 mb-4 flex flex-col overflow-hidden">
                        ...
                        <div className="flex-1 p-4 overflow-y-auto space-y-3 bg-white dark:bg-[#0a0a14]">
                            {chatMsgs.length === 0 && (
                                <div className="flex items-start gap-2">
                                    <div className="w-6 h-6 bg-[#f5f0ff] dark:bg-[#1a1025]/10 flex items-center justify-center shrink-0"><i className="fa-solid fa-robot text-[10px] text-[#7c3aed]"></i></div>
                            ...
                            {chatMsgs.map(m => (
                                <div key={m.id} className={`flex items-start gap-2 ${m.user ? 'flex-row-reverse' : ''}`}>
                                    <div className={`w-6 h-6 flex items-center justify-center shrink-0 ${m.user ? 'bg-[#e5e5e5] dark:bg-[#444]' : 'bg-[#f5f0ff] dark:bg-[#1a1025]/10'}`}>
                                        <i className={`fa-solid ${m.user ? 'fa-user text-[10px] text-[#999] dark:text-white/70' : 'fa-robot text-[10px] text-[#7c3aed]'}`}></i>
                                    </div>
                                    <div className={`px-3 py-2 text-sm max-w-[85%] ${m.user ? 'bg-[#7c3aed] text-white' : 'bg-white dark:bg-[#1a1025] border border-[#e5e5e5] dark:border-[#2d1f42] text-[#444] dark:text-white/80'}`}>{m.text}</div>
                                </div>
                            ))}
                            {chatLoading && (
                                <div className="flex items-start gap-2">
                        ...
                        <form onSubmit={sendChat} className="p-3 bg-white dark:bg-[#0d0d18] border-t border-[#e5e5e5] dark:border-[#1a1a2e] flex gap-2">
                            <input type="text" value={chatInput} onChange={e => setChatInput(e.target.value)} placeholder="Ketik pesan..." required className="flex-1 bg-white dark:bg-[#0a0a14] border border-[#e5e5e5] dark:border-[#2d1f42] text-sm px-4 py-2 focus:outline-none focus:border-[#7c3aed] transition-colors dark:text-white" />
