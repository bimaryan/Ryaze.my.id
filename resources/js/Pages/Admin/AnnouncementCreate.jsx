...
export default function AnnouncementCreate() {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        post(route('superadmin.announcements.store'));
    }
    ...
    return (
        <DashboardLayout title="Tambah Informasi">
            <div className="mb-1">
                <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                        <h1 className="text-lg font-bold text-[#333] dark:text-white">Tambah Informasi</h1>
                        <p className="text-[13px] text-[#999] dark:text-white/40">Buat informasi atau pengumuman baru untuk pengguna.</p>
                    </div>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="space-y-6">
                        <div>
                            ...
                            <input type="text" value={data.title} onChange={handleChange} required className={inputCls} placeholder="Contoh: Pembaruan Sistem v2.5" />
                        ...
                        <div>
                            ...
                            <textarea value={data.content} onChange={handleChange} rows="5" className={inputCls} placeholder="Jelaskan detail informasi atau pembaruan..." />
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <label className="relative inline-flex items-center cursor-pointer">
                                ...
                                <span className="ml-3 text-sm font-medium text-[#666] dark:text-white/60">Aktifkan sekarang</span>
                            </label>
                        ...
                        <div className="pt-4 border-t border-[#e5e5e5] dark:border-[#1a1a2e] flex justify-end">
                            <button type="submit" disabled={processing} className="bg-[#7c3aed] hover:bg-[#6d28d9] text-white font-bold py-2.5 px-6 rounded-lg shadow-md transition disabled:opacity-50">
                                <i className="fa-solid fa-save mr-2"></i>{processing ? 'Menyimpan...' : 'Simpan Informasi'}
                            </button>
                        </div>
                    </div>
                </form>
