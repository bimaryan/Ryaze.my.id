...
export default function PromoEventCreate() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        end_date: toLocalDatetime(in7Days),
        banner_image: null,
        is_active: true,
    });
    ...
    function handleSubmit(e) {
        e.preventDefault();
        post(route('admin.promo_events.store'), { forceFormData: true });
    }
    ...
    return (
        <DashboardLayout title="Tambah Promo Event">
            <div className="mb-1">
                <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                        <h1 className="text-lg font-bold text-[#333] dark:text-white">Tambah Promo Event</h1>
                        <p className="text-[13px] text-[#999] dark:text-white/40">Buat promo event baru untuk ditampilkan di dashboard.</p>
                    </div>
                ...
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-[#999] dark:text-white/40 mt-2">Opsional. Rekomendasi rasio gambar landscape (misal: 1200x400).</p>
                        ...
                        <div>
                            <label className="relative inline-flex items-center cursor-pointer">
                                ...
                                <span className="ml-3 text-sm font-medium text-[#666] dark:text-white/60">Aktifkan promo ini sekarang</span>
                            </label>
                        </div>
                        ...
                        <div className="pt-4 border-t border-[#e5e5e5] dark:border-[#1a1a2e] flex justify-end">
                            <button type="submit" disabled={processing} className="bg-[#7c3aed] hover:bg-[#6d28d9] text-white font-bold py-2.5 px-6 rounded-lg shadow-md transition disabled:opacity-50">
                                <i className="fa-solid fa-save mr-2"></i>{processing ? 'Menyimpan...' : 'Simpan Promo'}
                            </button>
                        </div>
                    </div>
                </form>
