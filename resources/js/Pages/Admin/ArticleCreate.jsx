...
export default function ArticleCreate({ categories }) {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        post(route('superadmin.articles.store'), { forceFormData: true });
    }
    ...
    return (
        <DashboardLayout title="Tulis Artikel Baru">
            <div className="mb-1">
                <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                        <h1 className="text-lg font-bold text-[#333] dark:text-white">Tulis Artikel Baru</h1>
                        <p className="text-[13px] text-[#999] dark:text-white/40">Buat konten artikel untuk blog Ryaze.</p>
                    </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-white dark:bg-[#0d0d18] border border-[#e5e5e5] dark:border-[#1a1a2e] rounded-xl shadow-sm p-6">
                            ...
                            <div className="mb-5">
                                ...
                                <input type="text" name="title" value={data.title} onChange={handleChange} required className={inputCls} placeholder="Judul artikel yang menarik..." />
                            ...
                            <div className="mb-5">
                                ...
                                <textarea name="excerpt" value={data.excerpt} onChange={handleChange} rows="3" className={inputCls} placeholder="Ringkasan singkat artikel (opsional, maks 500 karakter)..." />
                            ...
                            <div className="mb-5">
                                ...
                                <textarea name="body" value={data.body} onChange={handleChange} rows="20" className={`${inputCls} min-h-[400px] font-mono text-sm`} placeholder="Tulis konten artikel di sini (HTML)..." />
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-white dark:bg-[#0d0d18] border border-[#e5e5e5] dark:border-[#1a1a2e] rounded-xl shadow-sm p-6">
                            ...
                            <button type="submit" disabled={processing} className="w-full bg-[#7c3aed] hover:bg-[#6d28d9] text-white font-semibold text-sm py-3 rounded-lg transition shadow-sm disabled:opacity-50">
                                <i className="fa-solid fa-paper-plane mr-2"></i>{processing ? 'Menyimpan...' : 'Simpan Artikel'}
                            </button>
                        </div>
                        ...
                        <div className="bg-white dark:bg-[#0d0d18] border border-[#e5e5e5] dark:border-[#1a1a2e] rounded-xl shadow-sm p-6">
                            ...
                            <p className="text-xs text-[#999] dark:text-white/40 mt-2">Format: JPG, PNG, WEBP. Maks: 3MB.</p>
