...
export default function ArticleEdit() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(`/superadmin/articles/${article?.hashid || article?.id}`);
    };
                        ...
                        <div className="p-5 space-y-4">
                            ...
                            <div>
                                ...
                                {article?.featured_image && (
                                    <div className="mb-2">
                                        <img src={article.featured_image} alt="Current" className="w-32 h-20 object-cover border border-[#e5e5e5] dark:border-[#1a1a2e]" />
                                    </div>
                                )}
                                <input
                                    type="file"
