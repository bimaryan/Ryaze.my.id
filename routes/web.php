...
Route::middleware('auth')->group(function () {
    ...
    Route::get('admin/hosting/projects/pending', [HostingAdminDashboardController::class, 'pending'])->name('admin_hosting.pending');
    Route::get('admin/hosting/projects/deployments', [HostingAdminDashboardController::class, 'deployments'])->name('admin_hosting.deployments');
    Route::get('admin/hosting/projects/all', [HostingAdminDashboardController::class, 'projects'])->name('admin_hosting.projects');
