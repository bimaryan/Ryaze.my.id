...
class DashboardController extends Controller
{
    ...
    public function manageOrders()
    {
        ...
        return inertia('Joki/Admin/Orders', ['orders' => $orders]);
    }
    ...
    public function editOrder($hashid)
    {
        ...
        return inertia('Joki/Admin/EditOrder', ['order' => $order, 'consultation' => $consultation]);
    }
    ...
    public function financeReport()
    {
        ...
        return inertia('Joki/Admin/Finance', ['payments' => $payments, 'totalRevenue' => $totalRevenue]);
    }
}
