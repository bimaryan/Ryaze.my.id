...
class DatabaseManagerController extends Controller
{
    ...
    public function index(Request $request, $hashid)
    {
        ...
        try {
            ...
            return inertia('Hosting/User/DatabaseManager', ['database' => $database, 'tables' => $tables, 'type' => $type]);
    ...
    public function showTable(Request $request, $hashid, $tableName)
    {
        ...
        try {
            ...
            return inertia('Hosting/User/DatabaseManagerTable', ['database' => $database, 'tables' => $tables, 'tableName' => $tableName, 'columns' => $columns, 'rows' => $rows, 'page' => $page, 'totalPages' => $totalPages, 'totalRows' => $totalRows, 'type' => $type]);
